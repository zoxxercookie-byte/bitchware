...
function library:new(props)
	...
	local color = props.color or props.Color or props.mainColor or props.maincolor or props.MainColor or props.Maincolor or props.Accent or props.accent or Color3.fromRGB(169, 96, 48)
	-- // variables
	local window = {}
	-- // main
	...
	if props.backgroundImage then
		utility.new(
			"ImageLabel",
			{
				...
				ImageTransparency = props.backgroundTransparency or 0.6,
